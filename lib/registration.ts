...
import { runPiPingSmokeTest, tailTelegramRuntimeText } from "./runtime.ts";
import type { TelegramAutoReloadSmokeTestResult } from "./commands.ts";
...
- The Telegram bridge sends a quick '🫡 Принял, работаем.' acknowledgment; do not repeat short acks or emoji-only replies — start with the actual answer.`;
